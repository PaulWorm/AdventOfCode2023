...
def get_rank(hand):
    ...
    if 'J' in s_hand:
        if len(s_hand) == 1:
            return 6
        elif s_hand.most_common(1)[0][0] != 'J':
            s_hand[s_hand.most_common(1)[0][0]] += s_hand['J']
            del s_hand['J']
        else:
            s_hand[s_hand.most_common(2)[1][0]] += s_hand['J']
            del s_hand['J']
    if len(s_hand) == 1:
        return 6
    elif len(s_hand) == 2:
...
custom_sorting_order = ['A','K','Q','T','9','8','7','6','5','4','3','2','J']
